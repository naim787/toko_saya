<script>
  ...
  model.products = [
    {name: "Sepatu Jordan Garda", price: 15000, image: "./spatu.jpg", description: "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ipsa, commodi facere deserunt expedita quibusdam similique"}
  ]
</script>
