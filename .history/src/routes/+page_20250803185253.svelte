...
<div class="w-[100vw] h-auto flex flex-col justify-start items-center p-4 overflow-x-hidden font-mono">
 ...
 <div class="w-[109%] h-[75vh] flex flex-wrap justify-evenly items-start overflow-y-scroll">
  ...
  <!-- card -->
   <div class="card bg-base-100 w-83 h-85 shadow-xl  border p-2 flex flex-col bg-gray-100 m-1">
      ...
      <div class="w-45 my-auto">
        <button class="py-2 px-20 bg-green-500 rounded-xl font-thin">Add</button>
      </div>
   </div>
