...
<div class="w-[100vw] h-auto flex flex-col justify-start items-center p-4 overflow-x-hidden font-mono">
  ...
  <!-- wrap card -->
 <div class="w-[109%] h-[75vh] flex flex-wrap justify-evenly items-center overflow-y-scroll">
  
  <!-- card -->
   <div class="card bg-base-100 w-42.5 h-60 shadow-sm p-2 flex flex-col bg-gray-100 m-1">
  ...
  <!-- card -->
   <div class="card bg-base-100 w-43 h-60 shadow-sm p-2 flex flex-col bg-gray-100 m-1">
      <img src="spatu.jpg" alt="Shoes" class="w-45 h-30 rounded-xl object-cover mx-auto" />
      <h1 class="font-bold">Title Name</h1>
      <div class="w-35 mx-auto flex justify-between items-center">
        <h1 class="">Rp:15000</h1>
