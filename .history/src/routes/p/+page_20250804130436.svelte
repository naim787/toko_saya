              ...
              <div class="sm:col-span-8 lg:col-span-7">
                ...
                <section aria-labelledby="options-heading" class="mt-10">
                  ...
                  <form>
                    ...
                    <!-- Sizes -->
                    <fieldset aria-label="Choose a size" class="mt-10">
                      ...
                      <div class="mt-2 grid grid-cols-4 gap-3">
                        ...
                        <label aria-label="XXL" class="group relative flex items-center justify-center rounded-md border border-gray-300 bg-white p-3 has-checked:border-indigo-600 has-checked:bg-indigo-600 has-focus-visible:outline-2 has-focus-visible:outline-offset-2 has-focus-visible:outline-indigo-600 has-disabled:border-gray-400 has-disabled:bg-gray-200 has-disabled:opacity-25">
                          <input type="radio" name="size" class="absolute inset-0 appearance-none focus:outline-none disabled:cursor-not-allowed" />
                          <span class="text-sm font-medium uppercase group-has-checked:text-white">XXL</span>
                        </label>
                        <label aria-label="XXXL" class="group relative flex items-center justify-center rounded-md border border-gray-300 bg-white p-3 has-checked:border-indigo-600 has-checked:bg-indigo-600 has-focus-visible:outline-2 has-focus-visible:outline-offset-2 has-focus-visible:outline-indigo-600 has-disabled:border-gray-400 has-disabled:bg-gray-200 has-disabled:opacity-25">
                          ...
                          <span class="text-sm font-medium uppercase group-has-checked:text-white">XXXL</span>
                        </label>
                      </div>
                    </fieldset>
