...
<div class="w-[100vw] h-[100vh] flex flex-col justify-start items-center p-4">
 ...
 <div class="w-[109.5%] h-[47%] border flex flex-wrap justify-evenly items-center">
  <!-- card -->
   <div class="card bg-base-100 w-50 h-60 shadow-sm p-2 flex flex-col items-center justify-evenly bg-gray-300">
      <img src="spatu.jpg" alt="Shoes" class="w-42 h-42 rounded-2xl object-cover" />
