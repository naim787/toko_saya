...
<div class="w-[100vw] h-[100vh] flex flex-col justify-start items-center p-4">
	...
	<!-- content discont -->
	<div class="w-[95%] h-[130px] bg-black rounded-xl flex justify-evenly items-center p-3 border">
		<div class="">
	...
	<div class="w-[95%] flex justify-between items-start p-2 xl:p-4 border">
