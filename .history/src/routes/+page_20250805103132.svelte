<script>
  ...
  model.products = [
    {name: "Sepatu Jordan Garda", price: 12000, image: "./spatu.jpg", description: "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ipsa", color: ["red", "blue", "green", "yellow"], size: ["S", "M", "'"]},
  ]
</script>
