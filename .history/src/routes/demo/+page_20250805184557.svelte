<script>
  ...
  model.products = [
    ...
    {name: "ROLEX DAYTONA Jam Tangan Pria Emas Putih & Keramik Chronograph tachymeter", price: , image: "./spatu.jpg", description: "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ipsa", color: ["red", "blue", "green", "yellow"], size: ["S", "M", "L", "XL", "XXL"]},
