<script>
  ...
  model.products = [
    ...
    {name: "The Monseur Gallery", price: 56000, image: "./spatu.jpg", description: "Kaos Wanita Oversize Simple cute smiley face Style baju atasan wanita terbaru | Kaos baju Hitam", color: ["red-800", "blue-800", "green-500", "yellow"], size: ["S", "M", "L", "XL", "XXL"]},
