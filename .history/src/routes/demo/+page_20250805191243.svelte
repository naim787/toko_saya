<script>
  ...
  model.products = [
    ...
    {name: "Luffy Unbreakable Vow Cotton Combed", price: 12000, image: "https://down-id.img.susercontent.com/file/id-11134207-7ra0k-mcijoa9glwdz55.webp", description: "SUNNY SIDE UP Kaos T-shirt Anime Unisex StrawHat Pirates Luffy Unbreakable Vow Cotton Combed 24s", color: ["blue-500", "green-500", "black", "white"], size: ["S", "M", "L", "XL", "XXL"]},
