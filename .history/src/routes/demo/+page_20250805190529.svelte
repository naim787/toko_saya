<script>
  ...
  model.products = [
    ...
    {name: "Luffy Unbreakable Vow Cotton Combed", price: 12000, image: "https://down-id.img.susercontent.com/file/id-11134207-7ra0k-mcijoa9glwdz55.webp", description: "SUNNY SIDE UP Kaos T-shirt Anime Unisex StrawHat Pirates Luffy Unbreakable Vow Cotton Combed 24s", color: ["red-8", "blue", "green", "yellow"], size: ["S", "M", "L", "XL", "XXL"]},
