 <script>
  ...
  // color & size
  let selectedSize = "";  // untuk menyimpan size yang dipilih
  let selectedColor = ""; // untuk menyimpan warna yang dipilih
 </script>
          ...
          <div class="font-syerif">
            ...
            <div class="w-full flex flex-col border-y border-dotted py-2">
              ...
              <form class="filter">
                ...
                <input class="btn" type="radio" name="size" aria-label={siz}/>
                {/each}
              </form>
