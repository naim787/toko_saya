 <script>
  ...
  const noWa = "62895352455400"; // tanpa spasi atau tanda +
  const message = `saya iggin pesan pesan ka😍😎%0Anama product : ${dt?.name}%0Awarna : ${selectedColor}%0Asize : ${selectedSize}%0Ajumlah : ${value}%0ATERIMA KASIH❤❤❤`;
